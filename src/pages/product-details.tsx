        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                {/* Card glow effect - matching landing page */}
          ...
          >
            {[
              ...
              >
                ...
                <div className={`relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg ${item.shadowColor} border border-gray-200/50 hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]`}>
