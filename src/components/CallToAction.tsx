...
const CallToAction = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      {/* Background Layer */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary-dark to-transparent opacity-80 z-0"></div>
      <div className="absolute inset-0 bg-[url('/lovable-uploads/pexels-googledeepmind-18069156.jpg')] bg-cover bg-center mix-blend-multiply z-0"></div>

      {/* CTA Content */}
      <div className="container mx-auto px-6 md:px-12 xl:px-32 text-center relative z-10">
